...
## Framework แห่งยุคสมัย {#the-progressive-framework}
...
หากคุณเป็นนักพัฒนาที่มีประสบการณ์และสนใจวิธีการผสาน Vue เข้ากับ stack ของคุณ หรืออยากรู้ว่าคำเหล่านี้หมายถึงอะไร เราจะอธิบายรายละเอียดเพิ่มเติมในหัวข้อ [Ways of Using Vue](/guide/extras/ways-of-using-vue)
...
ใน Options API เราจะกำหนดตรรกะของคอมโพเนนต์โดยใช้ object ของ options เช่น `data`, `methods`, และ `mounted` คุณสมบัติที่กำหนดโดย options จะถูกเปิดเผยบน `this` ภายในฟังก์ชัน ซึ่งชี้ไปยังอินสแตนซ์ของคอมโพเนนต์:
